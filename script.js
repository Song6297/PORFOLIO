...
// ===================================
// ENHANCED SCROLL INDICATORS AND PROGRESS
// ===================================
function initScrollIndicator() {
    ...
    backToTopStyles.textContent = `
        .back-to-top {
            ...
            height: 50px;
            border-radius: 50%;
            background: linear-gradient(135deg, var(--royal-gold), var(--gold-hover));
            border: none;
            color: var(--white);
            cursor: pointer;
            opacity: 0;
    ...
    // Initialize lucide icons for back to top button
    setTimeout(() => {
        lucide.createIcons();
    }, 100);
}
